...
namespace Maticsoft.DAL
{
    ...
    public partial class Config
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Maticsoft.Model.Config model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Config(");
            strSql.Append("GUID,ConfigKey,ConfigValue)");
            strSql.Append(" values (");
            strSql.Append("@GUID,@ConfigKey,@ConfigValue)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@GUID", SqlDbType.NVarChar,-1),
					new SqlParameter("@ConfigKey", SqlDbType.NVarChar,-1),
					new SqlParameter("@ConfigValue", SqlDbType.NVarChar,50)};
            parameters[0].Value = model.GUID;
            parameters[1].Value = model.ConfigKey;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Maticsoft.Model.Config model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Config set ");
            strSql.Append("GUID=@GUID,");
            strSql.Append("ConfigKey=@ConfigKey,");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.Config GetModel(int ID)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.Config DataRowToModel(DataRow row)
        {
            Maticsoft.Model.Config model = new Maticsoft.Model.Config();
            if (row != null)
            {
                ...
                {
                    model.ConfigKey = row["ConfigKey"].ToString();
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,GUID,ConfigKey,ConfigValue ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,GUID,ConfigKey,ConfigValue ");
            strSql.Append(" FROM Config ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
