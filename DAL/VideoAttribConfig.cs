...
namespace Maticsoft.DAL
{
    ...
    public partial class VideoAttribConfig
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from VideoAttribConfig");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,GUID,VideoCategoryGUID,VideoAttribConfigName,VideoAttribConfigDescribe,VideoAttribConfigOrder ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,GUID,VideoCategoryGUID,VideoAttribConfigName,VideoAttribConfigDescribe,VideoAttribConfigOrder ");
            strSql.Append(" FROM VideoAttribConfig ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from VideoAttribConfig T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "VideoAttribConfig";
