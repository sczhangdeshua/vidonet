...
namespace Maticsoft.DAL
{
    ...
    public partial class VideoAttribValue
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from VideoAttribValue");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from VideoAttribValue ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,GUID,VideoDetailGUID,VideoAttribConfigGUID,VideoAttribValueValue ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,GUID,VideoDetailGUID,VideoAttribConfigGUID,VideoAttribValueValue ");
            strSql.Append(" FROM VideoAttribValue ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from VideoAttribValue T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "VideoAttribValue";
